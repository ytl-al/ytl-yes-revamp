...
namespace WPDeveloper\BetterDocs\Dependencies\PriyoMukul\WPNotice\Utils;
...
abstract class Base {
	...
	public static function get_instance( ...$args ) {
		...
		if( $module === 'WPDeveloper\BetterDocs\Dependencies\PriyoMukul\WPNotice\Notice' || $module === 'WPDeveloper\BetterDocs\Dependencies\PriyoMukul\WPNotice\Dismiss' ) {
