<div class="feedback-update-form">
    ...
    $flink_url = BetterDocs_DB::get_settings('feedback_url');
    $flink_url_href = $flink_url ? $flink_url : '#betterdocs-form-modal';
    $flink_attribute = array('class="feedback-form-link"');
    if ( $flink_url ) {
        $flink_attribute[] = 'href="'. esc_url($flink_url_href) .'"';
    } else {
        $flink_attribute[] = 'href="#betterdocs-form-modal"';
        $flink_attribute[] = 'name="betterdocs-form-modal"';
    }
    if ( $email_feedback == 1 ) {
    ?>
    <div class="feedback-form">
        <a <?php echo implode(' ', $flink_attribute) ?>>
