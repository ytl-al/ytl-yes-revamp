...
/**
	...
	private $path_get_ipp_tenure_details;
    	...
    	/**
	 * The api path to get Maybank IPP 88 details.
	 *
	 * @since    1.0.0
	 * @access   private
	 * @var      string    $path_get_ipp_88_details		The api path to get Maybank IPP 88 details.
	 */
	private $path_get_ipp_88_details;
	...
	public function __construct($plugin_name, $version, $prefix)
	{
		...
		$this->path_get_ipp_88_details		 = '/mobileyos/mobile/ws/v1/json/getIpay88IPPInstallmentList';
	...
	public function ca_generate_otp_for_guest_login_new($MobileNumber = null, $locale = 'EN')
	{
		...
		if ($MobileNumber != null && isset($this->api_domain) && isset($api_domain) && $session_id) {
	...
	public function get_ipp_tenures(WP_REST_Request $request) 
	{
		...
		$plan_name='Yes Infinite Plus Standard U 36M';
		$plan_id= '2542';
	...
	public function ca_get_ipp_tenures($plan_name = '') 
	{
		...
		if ($plan_name && isset($this->api_domain) && isset($this->api_request_id) && $session_id) {
			$params = ['planName' => $plan_name, 'requestId' => $this->api_request_id, 'locale' => $this->api_locale, 'sessionId' => $session_id,'bundleId' => '2542'];
	...
	public function ra_reg_get_ipp_88() 
	{
		register_rest_route('ywos/v1', 'get-ipp-88', array(
			'methods'	=> 'POST', 
			'callback' 	=> array($this, 'get_ipp_88'),
			'permission_callback' => '__return_true'
		));
	}

	public function get_ipp_88(WP_REST_Request $request) 
	{
		$plan_name	= $request['plan_name'];
		$plan_id	= $request['plan_id'];
		// $plan_name='Yes Infinite Plus Standard U 36M';
		
		return $this->ca_get_ipp_88($plan_name, $plan_id);
	}

	public function ca_get_ipp_88($plan_name = '', $plan_id = '') 
	{
		...
		$session_id 	= $this->ca_generate_auth_token(true);
		if ($plan_name && $plan_id && isset($this->api_domain) && isset($this->api_request_id) && $session_id) {
			$params = ['planName' => $plan_name, 'requestId' => $this->api_request_id, 'locale' => $this->api_locale, 'sessionId' => $session_id,'bundleId' => $plan_id];
			...
			$api_url	= $this->api_domain . $this->path_get_ipp_88_details;
