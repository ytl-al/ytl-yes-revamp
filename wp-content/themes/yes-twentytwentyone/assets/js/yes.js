    ...
    switch (eventType) {
        case 'ctCheckout':
            if (planType == 'postpaid') {
                ...
                eventName = foundWord ? 'Rahmah - Get Plan - Checkout ' : 'postpaid - Checkout';
            } else {
                eventName = 'Prepaid - Checkout';
            }
            break;
        ...
        case 'verification':
            if (planType == 'postpaid') {
                const searchWords = ["RAHMAH", "Wireless", "Infinite Basic_18M"];
                const foundWord = planName && searchWords.some(word => planName.includes(word));
                eventName = foundWord ? 'Rahmah - Get Plan - Checkout - Verification' : 'postpaid - Checkout - Verification';
            } else {
        ...
        case 'delivery details':
            if (planType == 'postpaid') {
                ...
                eventName = foundWord ? 'Rahmah - Get Plan - Checkout - Verification - Delivery Details' : 'Postpaid - Checkout - Verification - SIM Type - Delivery Details/Address';
            } else {
        ...
        case 'review & pay':
            if (planType == 'postpaid') {
                const searchWords = ["RAHMAH", "Wireless", "Infinite Basic_18M"];
                const foundWord = searchWords.some(word => planName.includes(word));
                eventName = foundWord ? 'Rahmah - Get Plan - Checkout - Verification - Delivery Details - Review & Order' : 'Postpaid - Checkout - Verification - SIM Type - Delivery Details/Address - Review & Pay';
            } else {
         ...
         case 'payment-info':
                if (planType == 'postpaid') {
                    const searchWords = ["RAHMAH", "Wireless", "Infinite Basic_18M"];
                    const foundWord = searchWords.some(word => planName.includes(word));
                    eventName = foundWord ? 'Rahmah - Get Plan- Payment Info' : 'Postpaid - Buy Now- Payment Info';
                } else {
            ...
            case 'payment-info-end':
                if (planType == 'postpaid') {
                    const searchWords = ["RAHMAH", "Wireless", "Infinite Basic_18M"];
                    const foundWord = searchWords.some(word => planName.includes(word));
                    eventName = foundWord ? 'Rahmah - Get Plan- Payment Info - End' : 'Postpaid - Buy Now- Payment Info - End';
                } else {
