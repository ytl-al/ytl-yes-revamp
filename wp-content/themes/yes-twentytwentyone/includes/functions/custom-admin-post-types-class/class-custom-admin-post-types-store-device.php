<?php
    ...
    /*
     * Functions to manage the admin page for custom post type "Store Device"
     */
    ...
    if (!class_exists('Yes_custom_admin_post_type_device')) {

        class Yes_custom_admin_post_type_device {

            protected $post_type    = 'store-device';
