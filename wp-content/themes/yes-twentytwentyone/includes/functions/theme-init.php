...
//  echo "</pre>";
    ...
    ?>
        ...
        <ul class="navbar-nav">
            ...
            ?>
            <li id="menu-item-20034" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20034 nav-item">
        ...
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                if ((jQuery('body.page-template-default').hasClass('page-id-33994')) || jQuery('body.page-template-default').hasClass('page-id-33994')) {
