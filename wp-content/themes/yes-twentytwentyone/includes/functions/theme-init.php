 ...
 * @since    1.0.0
 */
if (!function_exists('nav_add_li_class')) {
    function nav_add_li_class($classes, $item, $args)
    {
    ...
    add_filter('nav_menu_css_class', 'nav_add_li_class', 1, 3);
}
 ...
 * @since    1.0.0
 */
if (!function_exists('nav_add_link_class')) {
    function nav_add_link_class($atts, $item, $args)
    {
    ...
    add_filter('nav_menu_link_attributes', 'nav_add_link_class', 1, 3);
}
