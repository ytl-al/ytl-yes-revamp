...
//echo get_site_url();
                                        ...
                                        if ($lang == "en-US") {
                                            ?>
                                                                                ...
                                                                                <a class="custom_menu_nuv" href="<?php echo $url; ?>">
                            ...
                            <li class="nav-item dropdown mega-dropdown mobile-none">
                                ...
                                <ul class="dropdown-menu mega-dropdown-menu broadband_menu" aria-labelledby="navbarDropdown">
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-auto p-0 py-lg-4">
                                            <div class="tab-main-box">
                                                <div class="tab-box" id="tab-1" style="display:block;">
                                                    <div class="tab-box-inner p-3">
                                                        <li>
                                                            <ul>
                                                                <li id="menu-item-31205" class="dropdown-header menu-item menu-item-type-post_type menu-item-object-page menu-item-31205">
                    ...
                    ?>
                                                ...
                                                <div class="tab-box" id="tab-2">
                                                    <div class="tab-box-inners">
                                                        <div class="tab-menu tab-menu-inner">
                                                            <ul>
                                                                <li><a href="#" class="active dropdown-header yes_tab" data-rel="tab-3">Home Broadband</a></li>
                                                                <li><a href="#" data-rel="tab-4" class="dropdown-header">On the Go Broadband</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="tab-box px-5 py-4" id="tab-3" style="display:block;">
                                                        <li>
                                                            <ul>
                                                                <li id="menu-item-31205" class="dropdown-header menu-item menu-item-type-post_type menu-item-object-page menu-item-31205">
                    ...
                    ?>
                                                        ...
                                                        <div class="tab-box px-5 py-4" id="tab-4">  
                                                        <li>
                                                            <ul>
                                                                <li id="menu-item-31205" class="dropdown-header menu-item menu-item-type-post_type menu-item-object-page menu-item-31205">
                    ...
                    ?>
                            <li id="menu-item-31214" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-31214 nav-item">
                                <a href="<?php echo $menu_link_Wireless ?>" class="nav-link dropdown-toggle flex" id="navbarDropdowns" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo esc_html__('Campaign', 'yes.my'); ?>
                   
                                    <div class="parent">
                                        <button class="btn-gradient-2"><span class="badges">HOT</span></button>
                                    </div>
                                </a>
                                <ul class="dropdown-menu mega-dropdown-menu" aria-labelledby="navbarDropdowns" style="margin-top: 18px !important;">
                                    <div class="row mx-0">
                                  
                                        <div class="col-auto px-2 p-lg-4 py-lg-5 promlets">
                                            <li>
                                                <ul>
                                                    
                                                    <li class="dropdown-header">
                                        <a class="custom_menu_nuv" href="#">
                                        Merdeka promo</a></li>                    
                                                            <li class="dropdown-header">
                                        <a class="custom_menu_nuv" href="#">
                                        ...
                                        Wave Campagin</a></li>                    
                                                            <li class="dropdown-header">
                                        <a class="custom_menu_nuv" href="/nothing-phone">
                                        Nothing Phone</a></li>                    
                                                            <li class="dropdown-header">
                                        <a class="custom_menu_nuv" href="#">
                        ...
                        ?>
                                        ...
                                        if ($lang == "en-US") {
                                            ...
                                            ?>
                                                                                    <li class="dropdown-header">
                                                                                    <a class="custom_menu_nuv" href="<?php echo get_site_url() . '/ms' . $parse['path']; ?>">
                                                                                    <?php echo $navItem->title; ?> test</a></li>
                                                                                <?php
                                        }
                            ...
                            <div class="container-fluid g-0">
                                <div class="row m-0">
                                    ...
                                    <div class="languages-drop">
                                        ...
                                        <a class="active" href="<?php echo get_site_url() . '/en/' ?>">EN</a><span>|</span>
