...
function yes_menu($path)
{
    ?>
                    ...
                    <ul class="navbar-nav">
                        ...
                        ?>
                        <li id="menu-item-20033" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-20033 nav-item">
                            <a href=<?php echo $menu_link ?> class="nav-link"><?php echo esc_html__('iPhone', 'yes.my'); ?></a>
                        </li>
                    </ul>
                        <ul class="navbar-nav">
                            ...
                            <div class="row mx-0">
                                  ...
                                  <div class="col-auto px-2 p-lg-4 py-lg-5 promo">
                                      <li>
                                          ...
                                          <li class="dropdown-header">
                                  <a class="custom_menu_nuv" href="/e-sim/">Yes eSIM</a></li> 
                                  <li class="dropdown-header">
                                  <a class="custom_menu_nuv" href="/ookla/">OOKLA</a></li>     
                                    ...
                                    <div class="row mx-0">
                                        <div class="col-xl-8 col-lg-12 col-md-12 get_help mobile-none">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 col-md-6">
                                                    <li class="mega-get-help">
                                                        <img src="/wp-content/uploads/2023/11/network-status-icon.svg" alt="...">
                                                        <div class="">
                                                            <h6><a href="<?php echo get_site_url() . '/network-maintenance/' ?>"><?php echo esc_html__('Network Status', 'yes.my'); ?></a></h6>
                                                            <p>Check Yes network maintenance in Malaysia.</p>
                                        ...
                                        <div class="col-auto get_help-mobile dasktop-none">
                                            <ul>
                                                ...
                                                <li><a href="<?php echo get_site_url() . '/network-maintenance/' ?>"><img src="/wp-content/uploads/2023/11/network-status-icon.svg" alt="..."> Network Status</a></li>
