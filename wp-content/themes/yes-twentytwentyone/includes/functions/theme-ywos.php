...
function ywos_enqueue_scripts()
{
    ...
    wp_enqueue_style('ywos-css', get_template_directory_uri() . '/template-parts/ywos/assets/css/ywos.css', array(), '1.1.0');
    ...
    wp_enqueue_script('ywos-js', get_template_directory_uri() . '/template-parts/ywos/assets/js/ywos.js', array(), '2.0.0', true);
