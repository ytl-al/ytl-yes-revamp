...
function elevate_enqueue_scripts()
{
    ...
    wp_enqueue_script('elevatelib-js', get_template_directory_uri() . '/template-parts/elevate/assets/js/elevate.js?v=1', array(), '1.0.0', true);
    wp_enqueue_script('elevatelang-js', get_template_directory_uri() . '/template-parts/elevate/assets/js/elevate_lang.js?v=1', array(), '1.0.0', true);
