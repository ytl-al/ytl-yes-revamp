...
require_once(ADMIN_CUSTOM_POST_TYPE_CLASS_PATH . '/class-custom-admin-post-types-store-device.php');
...
if (!function_exists('yes_custom_posts_columns')) {
    ...
    function yes_custom_posts_columns()
    {
        ...
        if (post_type_exists('store-device'))              new Yes_custom_admin_post_type_device();
    }
