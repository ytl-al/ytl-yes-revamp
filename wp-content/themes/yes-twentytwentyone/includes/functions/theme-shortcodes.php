                                                        ...
                                                        <div class="col-12 col-lg-3 mb-2 mb-lg-0 mt-3 mt-lg-0">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu states" aria-labelledby="dropdownStates" data-filter-type="state">
                                                                    <li><div class="form-check"><label><input class="cardCheckBoxAll" data-filter-type="state" id="checkall" type="checkbox" value="All" checked /> <span>All</span></label></div></li>
                                                                    ...
                                                                    <li><div class="form-check"><label><input class="cardCheckBox state" type="checkbox" value="terrengganu" data-state-name="Terengganu" checked /> <span>Terrengganu</span></label></div></li>
                                                                    ...
                                                                    <li>
                                                                        <div class="form-check mb-0"><label><input class="cardCheckBox state" type="checkbox" value="putrajaya" data-state-name="Putrajaya" checked /> <span>Putrajaya</span></label></div></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-lg-5 mb-2 mb-lg-0">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownProducts" data-filter-type="service">
                                                                    <li><div class="form-check"><label><input class="cardCheckBoxAll" type="checkbox" value="All" data-filter-type="service" checked /> All</label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="postpaid-activation" data-service-name="Postpaid Activations" checked /> <span>Postpaid Activations</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="prepaid-activation" data-service-name="Prepaid Activations" checked /> <span>Prepaid Activations</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="postpaid-bill-payment" data-service-name="Postpaid Bill Payment" checked /> <span>Postpaid Bill Payment</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="prepaid-topup" data-service-name="Prepaid Top Up" checked /> <span>Prepaid Top Up</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="prepaid-reload-card" data-service-name="Prepaid Reload Card" checked /> <span>Prepaid Reload Card</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="device-sales" data-service-name="Yes Device Sales Only" checked /> <span>Yes Device Sales Only</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="debit-online" data-service-name="Auto Debit Application (Online)" checked /> <span>Auto Debit Application (Online)</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="change-details" data-service-name="Change of Customer Details" checked /> <span>Change of Customer Details</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="trouble-shooting" data-service-name="Yes Device Troubleshooting" checked /> <span>Yes Device Troubleshooting</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="device-configuration" data-service-name="Yes Device Configuration" checked /> <span>Yes Device Configuration</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="faulty-device" data-service-name="Faulty Device Replacement (Yes Device Only)" checked /> <span>Faulty Device Replacement (Yes Device Only)</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="service-query" data-service-name="Service Query" checked /> <span>Service Query</span></label></div></li>
                                                                    <li><div class="form-check"><label><input class="cardCheckBox service" type="checkbox" value="termination" data-service-name="Termination" checked /> <span>Termination</span></label></div></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-lg-4 mb-2 mb-lg-0">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownStoreTypes" data-filter-type="store-type">
                                                                    <li><div class="form-check"><label><input class="cardCheckBoxAll" type="checkbox" value="All" data-filter-type="store-type" checked /> All</label></div></li>
