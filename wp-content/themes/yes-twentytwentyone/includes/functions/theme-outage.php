...
if (!function_exists('generate_outgoing_network_maintenance')) {
    ...
    function generate_outgoing_network_maintenance()
    {
        ...
        if (!empty($json_res_4g_planed['Data'])) {
            ...
            $table_data = ' <div class="table-responsive data-table-section">
   ...
   ';
            ...
            if ($lang == "en-US") {
                $table_data = "<p class='para-sec'>There is no scheduled maintenance at the moment. We update this page on a regular basis, so please check back regularly.</p>";
            } elseif ($lang == "ms-MY") {
