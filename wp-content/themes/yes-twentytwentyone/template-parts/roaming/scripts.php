            ...
            if ($("[name=roamingSelect]").val()) {
                ...
                for (var i = 0; i < sel.length; i++) {
                 ...
                 // Remove hr if data-asiancountriesdays is not equal to "NoDay"
                    ...
                    if (cur['aseanPlusCountries'] !== 'NoDay') {
                        $('#header').html('<img class="mb-0" src="https://yesmy-dev.azurewebsites.net/wp-content/uploads/2024/05/roam-asian-logo.png" alt="YesRoam" /> <span data-countrytitle="aseanCountryTitle">' + cur['country_name'] + ' ' +'Daily Pass</span>');
                    } else {
                        $('#header').html('<img class="mb-0" src="/wp-content/uploads/2024/05/YesRoam-logo.png" alt="YesRoam" /> <span data-countrytitle="aseanCountryTitle">Day Pass</span>');
                    }
                ...
                $roamingTable.find('[data-asiancountriesdays="1Day"], [data-asiancountriesdays="NoDay"]').show();
                    ...
                    $('#daythree-tab').on('click', function() {
                        if (cur['aseanPlusCountries'] !== 'NoDay') {
                            ...
                            $('#header').html('<img class="mb-0" src="https://yesmy-dev.azurewebsites.net/wp-content/uploads/2024/05/roam-asian-logo.png" alt="YesRoam" /> <span data-countrytitle="aseanCountryTitle">' + cur['country_name'] + ' 3 Days Pass</span>');
                        } else {
                            $('.asean-storage-val').html('');
                            $('#header').html('<img class="mb-0" src="/wp-content/uploads/2024/05/YesRoam-logo.png" alt="YesRoam" /> <span data-countrytitle="aseanCountryTitle">Day Pass</span>');
                        }
                    ...
                    $('#dayseven-tab').on('click', function() {
                        if (cur['aseanPlusCountries'] !== 'NoDay') {
                            ...
                            $('#header').html('<img class="mb-0" src="https://yesmy-dev.azurewebsites.net/wp-content/uploads/2024/05/roam-asian-logo.png" alt="YesRoam" /> <span data-countrytitle="aseanCountryTitle">' + cur['country_name'] + ' 7 Days Pass</span>');
                        } else {
                            $('.asean-storage-val').html('');
                            $('#header').html('<img class="mb-0" src="/wp-content/uploads/2024/05/YesRoam-logo.png" alt="YesRoam" /> <span data-countrytitle="aseanCountryTitle">Day Pass</span>');
                        }
