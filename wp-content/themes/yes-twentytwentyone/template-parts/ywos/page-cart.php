                    ...
                    <div class="packagebox mb-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-12 ps-4 pe-4">
                                ...
                                <div class="package-info d-none">
                                    <div class="row">
                                        <div class="col-6 mb-2">
                                            <img src="/wp-content/themes/yes-twentytwentyone/template-parts/ywos/assets/images/tickoutline.png" class="me-1" alt="" />6 months free
                                        </div>
                                        <div class="col-6 mb-2">
                                            <img src="/wp-content/themes/yes-twentytwentyone/template-parts/ywos/assets/images/tickoutline.png" class="me-1" alt="" />Unlimited Borak
                                        </div>
                                        <div class="col-6">
                                            <img src="/wp-content/themes/yes-twentytwentyone/template-parts/ywos/assets/images/tickoutline.png" class="me-1" alt="" />Unlimited Duit
                                        </div>
                                        <div class="col-6">
                                            <img src="/wp-content/themes/yes-twentytwentyone/template-parts/ywos/assets/images/tickoutline.png" class="me-1" alt="" />4G Paling Power
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6 pb-1 border-bottom text-end">
                                    <p>RM{{ parseFloat(due.addOns).toFixed(2) }}</p>
                                </div>
                                <div class="col-6 pb-1 pt-1 border-bottom">
                                    <p>Taxes</p>
                                </div>
                                <div class="col-6 pb-1 pt-1 border-bottom text-end">
                                    <p>RM{{ parseFloat(due.taxes).toFixed(2) }}</p>
                                </div>
                                <div class="col-6 pb-1 pt-1 border-bottom">
                                    <p>Shipping fee</p>
                                </div>
                                <div class="col-6 pb-1 pt-1 border-bottom text-end">
                                    <p>RM{{ parseFloat(due.shippingFees).toFixed(2) }}</p>
                                </div>
                            </div>
                            <div class="d-none">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6 text-end">
                                    <p class="large">RM{{ parseFloat(summary.total).toFixed(2) }}</p>
                                </div>
                            </div>
                ...
                <div class="summary-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pt-2 pb-2 text-end">
                            <h3>RM{{ parseFloat(summary.total).toFixed(2) }}</h3>
                        </div>
                    </div>
            ...
            <div class="modal-body pt-5 pb-5">
                <div class="row justify-content-center mb-4">
                    <div class="col-lg-9 col-12 mb-lg-0 mb-2 align-self-center">
                        <a href="#" class="white-btn2 d-block">Continue checkout as Guest</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-12 mb-lg-0 mb-2 align-self-center">
                        ...
                        <ul class="nav justify-content-center nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">TAC</button>
                            </li>
                            <li class="nav-item" role="presentation" style="margin-left: -20px;">
                                <button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Password</button>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <div class="input-box">
                                    <div class="w-100 border-bottom">
                                        <input class="form-control userid" type="text" placeholder="YES ID" />
                                    </div>
                                    <div class="w-100">
                ...
                <div class="row justify-content-center">
                    <div class="col-6 mb-lg-0 mb-2 align-self-center text-center">
                        <a href="#" class="pink-btn d-block mb-3">Login</a>
    ...
    var pageCart = new Vue({
        ...
        methods: {
            ...
            updateSummary: function() {
                var self = this;
                var total = 0;
                self.summary.total = parseFloat(self.plan.totalAmount) + parseFloat(self.due.addOns) + parseFloat(self.due.taxes) + parseFloat(self.due.shippingFees);
            },
