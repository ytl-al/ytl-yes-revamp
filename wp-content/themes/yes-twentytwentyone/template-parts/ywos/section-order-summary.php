        ...
        <template v-for="item in orderSummary.due.priceBreakdown.simplified">
            <template v-if="item.parentFlag">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-4 pt-2 pb-2 text-end">
            ...
            <template v-else>
                <div class="row" v-if="!['Deposit for Foreigner', 'SST @6%', 'Rounding Adjustment'].includes(item.priceDisplayName)">
                    ...
                    <div class="col-4 text-end">
                        <p class="large" v-if="deliveryInfo.securityType == '' || deliveryInfo.securityType == 'NRIC'"><strong>{{ item.malaysianPriceValue.replace('(-1)', '(-) ') }}</strong></p>
                        <p class="large" v-if="deliveryInfo.securityType != '' && deliveryInfo.securityType != 'NRIC'"><strong>{{ item.nonMalaysianPriceValue.replace('(-1)', '(-) ') }}</strong></p>
                    </div>
                </div>
            </template>
        </template>
