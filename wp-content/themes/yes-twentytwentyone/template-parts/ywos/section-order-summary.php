...
<div class="row" v-if="orderSummary.plan.planType != 'prepaid' && ywos?.lsData?.meta.planID != '1229' && ywos?.lsData?.meta.planID != '1231' && ywos?.lsData?.meta.orderSummary.plan.displayName !='Infinite Basic RAHMAH 1' && ywos?.lsData?.meta.orderSummary.plan.displayName !='Infinite Basic RAHMAH 2' && ywos?.lsData?.meta.orderSummary.plan.displayName !='Infinite Basic RAHMAH 3' && ywos?.lsData?.meta.orderSummary.plan.displayName !='Power 35 RAHMAH' && ywos?.lsData?.meta.orderSummary.plan.displayName !='Infinite Basic_24M'">
            <div class="col-12 mb-3">
                <p class="large">{{ orderSummary.plan.displayName }}</p>
            </div>
        </div>

            <div class="col-12 mb-3" v-for="plan in rahmahPlan" :key="plan.planId">
                <p class="large" v-if="ywos?.lsData?.meta.planID == plan.planId">{{ plan.planName }}</p>
            </div>
