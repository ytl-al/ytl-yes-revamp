...
.hero-slider .inner-content-sec .pricing-2 .month-sec {
    ...
    .hero-slider .inner-content-sec .pink-btn {
        background-color: #2F3BF5 !important;
    ...
    .offerline-section {
        ...
        background-image: linear-gradient(to right, #FF0084, #4B0128);
        padding: 30px 0px;
        margin: 0;
        position: relative;
    }

    .offerline-section h2 {
        font-family: 'Montserrat';
        font-style: normal;
        font-weight: 400;
        font-size: 32px;
    ...
    /* #device-main-section .container-fluid{
        padding-left: 0;
        padding-right: 0;
        overflow: hidden;
    } */
    ...
    .device_cat_search input.form-control {
        width: 100% !important;
    ...
    .storeitem-supported-devices [data-aos][data-aos][data-aos-duration="400"],
    ...
    #device-list-section .layer-planDevice:hover {
        -webkit-transform: translateY(-6px);
        transform: translateY(-6px);
        transition: all .4s ease-in-out;
    }

    #device-list-section .layer-planDevice:hover:before {
        opacity: 1;
        transition: all .4s ease-in-out
    }
...
.offer-block {
    ...
    .panel-colors .span-colorAvailableText {
        color: #000;
        display: block;
        font-weight: 700;
        margin: 0 0 8px;
    ...
    .panel-colors .span-color,
    .panel-colors .span-color-a {
        background-color: transparent;
    ...
    .panel-colors .span-color:last-of-type,
    .panel-colors .span-color-a:last-of-type {
        margin-right: 0;
    }
    ...
    .span-color.bright-grey:after {
        background-color: #575060
    }

    .span-color.gold:after {
        background-color: #F0E8D3
    }

    .span-color.silver:after {
        background-color: #E4DCEA
    }

    .span-color.space-black:after {
        background-color: #3F3D3D
    }

    .span-color.apple-blue:after {
    ...
    .slick-dots li button:before {
        ...
        #device-main-section .col {
            flex: unset;
        }

        /* #device-main-section .container-fluid{overflow: unset;} */
    ...
    .phone-box {
        border-radius: 12px;
        background: #FFF;
        box-shadow: 2px 4px 8px 0px rgba(26, 30, 71, 0.10);
    }
    ...
    .phone-box .phone-box-content span {
        color: #000;
        text-align: center;
        font-family: Montserrat;
        font-size: 18px;
    ...
    .phone-box .phone-box-content h6 {
        color: #000;
        text-align: center;
        font-family: Montserrat;
        font-size: 24px;
