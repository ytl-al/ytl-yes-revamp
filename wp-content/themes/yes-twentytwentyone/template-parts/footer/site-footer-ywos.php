...
<!-- Footer STARTS -->
<footer class="page-footer footer footer-noMenu">
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-2 d-flex align-items-center justify-content-md-start justify-content-sm-center">
                    <img src="https://cdn.yes.my/site/wp-content/themes/yes-twentytwentyone/template-parts/elevate/assets/images/logomark.png" height="40" />
                </div>
                ...
                <div class="col-12 col-md-5 d-flex align-items-center justify-content-md-end justify-content-sm-center">
                    <img src="https://cdn.yes.my/site/wp-content/uploads/2021/09/footer-icons-1.png" class="img-fluid" />
                </div>
            </div>
        </div>
    </div>
