        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-6">
                    <div class="mt-4">
                        <a href="/elevate/cart/" class="back-btn "><img src="/wp-content/themes/yes-twentytwentyone/template-parts/elevate/assets/images/back-icon.png" alt=""> {{ renderText('back') }}</a>
                    </div>
                </div>
                                ...
                                <div>
                                            ...
                                            <div class="">
                                                <div class="row">
                                                    <div class="col-lg-4 col-5">
                                                        <select v-model="eligibility.cardtype" class="" style="width:100%" id="cardtype" name="cardtype">
                                                            <option value="1">{{ renderText('MyKad') }}</option>
                                                            <option value="2">{{ renderText('MyTentera') }}</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-lg-8 col-7">
                                                        <input type="text" pattern="[0-9]+" minlength="12" maxlength="12" class="form-control text-uppercase" id="mykad_number" name="mykad" v-model="eligibility.mykad" @input="watchAllowNext" @change="watchAllowNext" @keypress="isNumber($event)" min="0" placeholder="" required>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-8 col-12">
                                            ...
                                            <div class="input-group align-items-center">
                                                <input type="text" class="form-control text-uppercase" id="full_name" name="name" v-model="eligibility.name" @keypress="checkInputFullName(event)" @input="watchAllowNext" @change="watchAllowNext" placeholder="" required>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-8 col-12">
                                            ...
                                            <div class="align-items-center">
                                                <input type="text" class="form-control text-uppercase" id="dob" name="dob" v-model="eligibility.dob" placeholder="" readonly>
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center g-2">
                                        ...
                                        <div class="col-lg-8 col-12">
                                            <div class="row">
                                                <div class="col-lg-4 col-5">
                                                    <input type="text" class="form-control text-center" id="ic_passport_number" placeholder="MY +60" readonly>
                                                </div>
                                                <div class="col-lg-8 col-7">
                                                    <input type="text" pattern="[0-9]+" min="0" class="form-control text-uppercase" maxlength="10" id="ic_phone_number" name="phone" v-model="eligibility.inphone" @input="watchAllowNext" @keypress="isNumber($event)" :placeholder="renderText('phone_number')">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-8 col-12">
                                            ...
                                            <div class="align-items-center">
                                                <input type="text" class="form-control text-uppercase" id="email" name="email" v-model="eligibility.email" @input="watchAllowNext" placeholder="" required>
                                            </div>
                                            <div class="invalid-feedback mt-1" id="em-email"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6">
                                            <button class="text-uppercase" @click="goNext" :class="allowSubmit?'pink-btn':'pink-btn-disable'" type="button">{{ renderText('check_eligibility') }}
                                            </button>
                                        </div>
        ...
        var pageCart = new Vue({
            ...
            data: {
                ...
                input: {
                    ...
                    phone: {
                        field: '#ic_phone_number',
                        errorMessage: '#em-phone'
                    },
                    email: {
                        field: '#email',
            ...
            methods: {
                ...
                DDMFEligibility: function() {
                    ...
                    toggleOverlay();
                    // $('#status_mesage').html('Checking compAsia...');
                    axios.post(apiEndpointURL_elevate + '/verify-ddmf' + '?nonce=' + yesObj.nonce, params)
                        .then((response) => {
                            ...
                            if (data.result == "Success") {
                                ...
                                if (self.orderSummary.product.selected.productCode) {
                                    ...
                                    //             var upfrontData=JSON.stringify(data)
                                    //             localStorage.setItem('yesElevate',upfrontData)
                                    //             toggleModalAlert('Error',this.renderText('NRIC_is_not_d_dmfcheck'),"elevate.redirectToPage('eligibility-fail-upfront')");
                                    //         }
                                    //     }else{
                    ...
                    axios.post(apiEndpointURL_elevate + '/check-active-contract?t=' + t + '&nonce=' + yesObj.nonce, params)
                        .then((response) => {
                            ...
                            if (data == 1) {
                                ...
                                console.log('testt');
                                self.DDMFEligibility(); // Moved by AL
                                console.log('AL');
