                ...
                <div class="row gx-5" v-if="pageValid">
                    ...
                    <form class="col-lg-8 col-12 order-lg-1 mt-3 mt-lg-0" autocomplete="off" @submit="paymentSubmit">
                        <div>
                            ...
                            <h2 class="subtitle">Select payment</h2>
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button type="button" class="nav-link" id="nav-creditcard" role="tab" data-paymentnav="CREDIT_CARD" data-bs-toggle="pill" data-bs-target="#tab-creditcard" aria-controls="tab-creditcard" aria-selected="false" v-on:click="selectPaymentMethod('CREDIT_CARD')">
                                        <img src="/wp-content/themes/yes-twentytwentyone/template-parts/elevate/assets/images/creditcard.png"  height="32" />
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button type="button" class="nav-link" id="nav-fpx" role="tab" data-paymentnav="FPX" data-bs-toggle="pill" data-bs-target="#tab-fpx" aria-controls="tab-fpx" aria-selected="false" v-on:click="selectPaymentMethod('FPX')">
                                        <img src="/wp-content/themes/yes-twentytwentyone/template-parts/elevate/assets/images/fpx-logo.png"  height="32" />
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button type="button" class="nav-link" id="nav-creditcard" role="tab" data-paymentnav="CREDIT_CARD_IPP" data-bs-toggle="pill" data-bs-target="#tab-creditcard" aria-controls="tab-creditcard" aria-selected="false" v-on:click="selectPaymentMethod('CREDIT_CARD_IPP')">
                                        <img src="/wp-content/themes/yes-twentytwentyone/template-parts/elevate/assets/images/grabpay.png" height="32" />
                                    </button>
                                </li>
                            </ul>
                                    ...
                                    <div class="tab-paneContent">
                                        ...
                                        <div class="row mb-3 align-items-center g-2">
                                            ...
                                            <div class="col-lg-6 col-12 mb-1">
                                                <div class="input-group align-items-center">
                                                    <input type="text" class="form-control text-center" id="input-cardInput1" v-model="cardholder.number1" placeholder="****" maxlength="4" @input="checkCardInputJump(1, event)" @keypress="checkInputCharacters(event, 'numeric', false)" /><span class="mx-1">-</span>
                                                    <input type="text" class="form-control text-center" id="input-cardInput2" v-model="cardholder.number2" placeholder="****" maxlength="4" @input="checkCardInputJump(2, event)" @keypress="checkInputCharacters(event, 'numeric', false)" /><span class="mx-1">-</span>
                                                    <input type="text" class="form-control text-center" id="input-cardInput3" v-model="cardholder.number3" placeholder="****" maxlength="4" @input="checkCardInputJump(3, event)" @keypress="checkInputCharacters(event, 'numeric', false)" /><span class="mx-1">-</span>
                                                    <input type="text" class="form-control text-center" id="input-cardInput4" v-model="cardholder.number4" placeholder="****" maxlength="4" @input="checkCardInputJump(4, event)" @keypress="checkInputCharacters(event, 'numeric', false)" />
                                                </div>
                                            </div>
    ...
    $(document).ready(function() {
        ...
        var pageDelivery = new Vue({
            ...
            methods: {
                ...
                updateData: function() {
                    var self = this;
                    self.orderSummary = elevate.lsData.meta.orderSummary;
                    self.deliveryInfo = elevate.lsData.meta.deliveryInfo;

                    console.log("self.orderSummary ",self.orderSummary );
                ...
                redirectThankYou: function() {
                    ...
                    // elevate.redirectToPage('thank-you');
                },
