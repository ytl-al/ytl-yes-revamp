    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-6 text-lg-center text-end">
                <h1 class="title_checkout p-3">{{renderText('pre_register_delivery')}}</h1>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="row d-none d-md-block">
                                <div class="col-12">
									...
									<button class="pink-btn-disable text-uppercase" onclick="goBack()" type="button">{{ renderText('cancel') }}
                                    </button>
                                </div>
                            </div>
                        </div>
