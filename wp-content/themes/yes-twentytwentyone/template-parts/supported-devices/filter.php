<section id="filter-panel">
    ...
    <div class="container d-block d-sm-none">
        <div class="dropdown xs-filter-container">
            <button class="btn filter-drop dropdown-toggle" type="button" id="xsRegionState" data-bs-toggle="dropdown" aria-expanded="false">Filter by Data Mode</button>
                ...
                ?>
                    <li>
                        <div class="form-check">
                            <label>
                                <input class="cardCheckBox" type="checkbox" id="tag-<?= $tag->term_id ?>" name="xs-c-region" value="<?= $tag->slug ?>"> <span><?= $tag->name ?></span>
                            </label>
                        </div>
                    </li>
                <?php
