<section id="supported-device">
    ...
    <div class="container d-block d-sm-none">
        <div class="dropdown xs-filter-container">
            <button class="btn filter-drop dropdown-toggle" type="button" id="dropdownStates" data-bs-toggle="dropdown" aria-expanded="false"><?php echo esc_html__('Filter By Phone Brand', 'yes.my'); ?></button>
    ...
    <div class="text-end mt-4 mb-4">
        <div class="dropdown filter-drop">
            <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                <?php echo esc_html__('Sort By', 'yes.my'); ?> <span id="sd-current_sort">Terkini</span>
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item sd-sort" href="#" data-direct="ASC">Terdahulu</a></li>
                <li><a class="dropdown-item sd-sort d-none" href="#" data-direct="DESC">Terkini</a></li>
            </ul>
        </div>
    </div>
